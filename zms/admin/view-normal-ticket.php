                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body" id="exampl">
                                        <?php
 $vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tblticindian where t_id='$vid'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {

?>
                                        <h4 class="header-title" style="color: blue">Ticket ID: <?php  echo $row['t_id'];?></h4>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 10px"><?php  echo $nochild=$row['nochild'];?></td>
                                    <td style="padding-left: 10px">$<?php  echo $aup=$row['childprice'];?></td>
