				...
				<div class="container">
					...
					<div class="banner-grids">
						<div class="col-md-6 banner-grid">
							<h4>Relaxing with family and peers </h4>
							<p>we get to much indulge in our day to day live that we forget to enjoy the moments with our close one.Well not TODAYY</p>
						</div>
						<div class="col-md-6 banner-grid">
						<h4>Adventure ahead</h4>
							<p>enjoy the live view to wildlife close enough to make u fell alive</p>
						</div>
